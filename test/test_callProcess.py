...
LAST_CALL_ID_FILE = 'last_call_id_all2.txt'
...
"""
    ...
    comment_prompt = f"""Расскажите подробно, учитывая все детали, что хочет клиент? Не упоминай имён людей, названия компаний и бренды. Начинай со слова "Интересуется ..." 
Текст:
{roles_text}   
"""
